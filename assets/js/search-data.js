      ...
      window.location.href = "/";
        ...
        handler: () => {
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/membership_inference_attacks/";
            },},{id: "projects-object-detection-using-faster-r-cnn-and-yolo",
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/guangzhi-su", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=FL3wqrcAAAAJ", "_blank");
        },
      },{
      id: 'light-theme',
